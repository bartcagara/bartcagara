        ...
        <div className={styles.container}>
          <div className={styles.maxW800}>
            ...
            <p className={`${styles.textLargeNarrative} ${styles.textCenter}`} style={{ marginTop: '1.5rem' }}>
              A rapid diagnostic to identify exactly why your previous attempts have failed.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className={styles.maxW800}>
            ...
            <div className={styles.calEmbed}>
              ...
              <script type="text/javascript" dangerouslySetInnerHTML={{
                ...
                // Initialize with retry logic for hard refreshes
                ...
                // Start initialization after a brief delay to ensure script loads
                setTimeout(initCalEmbed, 50);
              `}} />
