...
/** The Diagnosis — narrative pain copy in a glass column on navy. */
export function SleekDiagnosis() {
  const { diagnosis } = HOMEPAGE_CONTENT;
  return (
    <section
      className="relative overflow-hidden bg-bleu-nuit py-24 md:py-32"
      aria-labelledby="sleek-diagnosis-title"
    >
      <Glow className="-left-32 top-1/3 h-[420px] w-[420px] bg-bleu-charron opacity-20" />

      <div className="relative mx-auto max-w-4xl px-6">
        <div className="mb-14 text-center">
          <Eyebrow label="The Diagnosis" />
          <h2
            id="sleek-diagnosis-title"
