...
export function HeroSection({ content }: HeroSectionProps) {
  return (
    <section className="border-b-2 border-white/10 bg-bleu-nuit overflow-hidden" role="banner">
      <div className="max-w-7xl mx-auto px-6 pt-24 pb-20 md:pt-48 md:pb-32">
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-[8rem] font-black uppercase tracking-tighter leading-[0.85] mb-8 md:mb-12 text-white max-w-5xl">
          {content.headline}<br />
