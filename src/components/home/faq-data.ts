...
export const FAQ_ITEMS: FAQItems = [
  {
    ...
    a: "<p>Yes, it is free. I have met many amazing people through these audits over the years. Many went on to become clients; many didn't.</p><p>Here is the reality: If we are a good fit, we will both know it by the end of the call, and we can schedule a time to talk about working together.</p><p>If not, you walk away with a diagnosis and a fix you can use immediately. No pitch. No pressure. Just clarity.</p>",
  },
  {
