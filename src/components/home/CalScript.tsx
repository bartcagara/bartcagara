 ...
 * - Registers the floating button (bottom-right, "Book Call")
...
export function CalScript() {
  useEffect(() => {
    ...
    script.textContent = `
      ...
      Cal.ns["discovery-call"]("floatingButton", {"calLink":"bartcagara/discovery-call","config":{"layout":"month_view","useSlotsViewOnSmallScreen":"true"},"buttonColor":"#09071D","buttonTextColor":"#FFFFFF","buttonPosition":"bottom-right","buttonText":"Book Call"});
