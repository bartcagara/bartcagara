...
import { CAL_NAMESPACE, CAL_ORIGIN } from "@/lib/cal";
...
export function CalScript() {
  useEffect(() => {
    ...
    script.textContent = `
      ...
      Cal.ns["${CAL_NAMESPACE}"]("ui", {"cssVarsPerTheme":{"light":{"cal-brand":"#09071D"},"dark":{"cal-brand":"#F9FAFB"}},"hideEventTypeDetails":false,"layout":"month_view"});
    `;
