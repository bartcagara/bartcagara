        ...
        stages: [
            {
                number: 1,
                title: "THE RESET",
                description: "We fix your nutrition and training immediately so you stop spinning your wheels.",
                items: [
                    "Your custom Nutrition Protocol (no starvation).",
                    "Efficient Strength Foundation (30-min sessions).",
                    "Immediate fix for energy crashes and brain fog.",
                ],
                deliverable: "Full control over your energy and hunger.",
                rhythm: "Unlimited Async Access (WhatsApp) + Strategic Check-ins",
            },
            {
                number: 2,
                title: "THE BUILD",
                description: "We build the muscle and metabolism you need to look the part.",
                items: [
                    "Hypertrophy training designed for the executive schedule.",
                    "Building the lean muscle that keeps you lean long-term.",
                    "Solving the 'Travel Gap' (Airport/Hotel protocols).",
                ],
                deliverable: "Visible physical changes and better fitting clothes.",
                rhythm: "Unlimited Async Access (WhatsApp) + Strategic Check-ins",
            },
            {
                number: 3,
                title: "THE STRESS-TEST",
                description: "We make sure the results stick even when your schedule goes to hell.",
                items: [
                    "Navigating heavy travel weeks without gaining weight.",
                    "Handling back-to-back client dinners with zero guilt.",
                    "Advanced recovery protocols for high-stress periods.",
                ],
                deliverable: "Total confidence that you can handle any schedule.",
                rhythm: "Unlimited Async Access (WhatsApp) + Strategic Check-ins",
            },
            {
                number: 4,
                title: "THE EXIT",
                description: "You master the system so you don't need to pay me anymore.",
                items: [
                    "Internalizing the principles (Intuition vs. Rules).",
                    "Transitioning from 'Coached' to 'Autonomous'.",
                    "Final optimization for longevity and bloodwork.",
                ],
                deliverable: "Full Autonomy. You fire me because you've mastered it.",
                rhythm: "Unlimited Async Access (WhatsApp) + Strategic Check-ins",
            },
        ],
        ctaText: "BOOK A 15-MIN RAPID AUDIT",
