...
export const HOMEPAGE_CONTENT = {
  ...
  solution: {
    ...
    items: [
      ...
      "Still working hard, still meeting investors, still traveling...",
      "But something's different. Things are clicking. No more panic attacks. You're confident now—and your body carries that message.",
