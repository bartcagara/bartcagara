...
export const HOMEPAGE_CONTENT = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "I got them.",
      "Not because I lived their exact path, but because I understood what they valued: growth over status quo, building over politics, freedom over bureaucracy.",
      "The problem wasn't discipline. It was that every fitness system assumes you have a predictable schedule, low stress, and time to meal prep.",
      "Founders don't live like that.",
      "So I built something different. A system that works when you're taking investor calls at night, stress-eating because a deal fell through, or played relaxed and planning your next move during a family weekend.",
      "I've built a business from scratch. I know the chaos. I know what breaks.",
      "And I know how to fix it without asking you to live like someone with a 9-to-5.",
    ],
